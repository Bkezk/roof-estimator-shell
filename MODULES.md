...
| Prospecting      | `prospect`  | `/prospect`                       | `src/routes/prospect.tsx`, `src/components/prospect-page.tsx`, `src/lib/prospect.ts`, `src/lib/prospect.functions.ts`                                         | `buildings`, `roofs`, `tasks`               |
